...
def process_resource( job_information, this_region, resource_id ):
        ...
        for r in sg_client.describe_security_groups()['SecurityGroups']:
            ...
            if resource_id == 'none' or resource_id == r['GroupId']:

                add_resource.run( resource_name, r['GroupId'], all_tags, this_region )
